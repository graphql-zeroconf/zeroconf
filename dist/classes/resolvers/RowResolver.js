...
/*#__PURE__*/
function (_Resolver) {
  _inherits(RowResolver, _Resolver);

  function RowResolver() {
    _classCallCheck(this, RowResolver);

    return _possibleConstructorReturn(this, _getPrototypeOf(RowResolver).apply(this, arguments));
  }

  _createClass(RowResolver, [{
    key: "_resolve",
    value: function () {

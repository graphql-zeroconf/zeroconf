...
/*#__PURE__*/
function (_Resolver) {
  _inherits(CountResolver, _Resolver);

  function CountResolver() {
    _classCallCheck(this, CountResolver);

    return _possibleConstructorReturn(this, _getPrototypeOf(CountResolver).apply(this, arguments));
  }

  _createClass(CountResolver, [{
    key: "_resolve",
    value: function () {

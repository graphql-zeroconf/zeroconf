...
/*#__PURE__*/
function (_Resolver) {
  _inherits(CreateResolver, _Resolver);

  function CreateResolver() {
    _classCallCheck(this, CreateResolver);

    return _possibleConstructorReturn(this, _getPrototypeOf(CreateResolver).apply(this, arguments));
  }

  _createClass(CreateResolver, [{
    key: "_resolve",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                this.pubSub.publish(TypeName, _defineProperty({}, typeName, createdRow));

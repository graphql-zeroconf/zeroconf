...
/*#__PURE__*/
function (_Resolver) {
  _inherits(DeleteResolver, _Resolver);

  function DeleteResolver() {
    _classCallCheck(this, DeleteResolver);

    return _possibleConstructorReturn(this, _getPrototypeOf(DeleteResolver).apply(this, arguments));
  }

  _createClass(DeleteResolver, [{
    key: "_resolve",
    value: function () {

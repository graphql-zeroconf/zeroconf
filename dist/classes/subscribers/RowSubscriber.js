...
/*#__PURE__*/
function (_Resolver) {
  (0, _inherits2["default"])(RowSubscriber, _Resolver);

  function RowSubscriber() {
    (0, _classCallCheck2["default"])(this, RowSubscriber);
    return (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(RowSubscriber).apply(this, arguments));
  }

  (0, _createClass2["default"])(RowSubscriber, [{
    key: "_resolve",
    value: function () {

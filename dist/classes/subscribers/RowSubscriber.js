...
/*#__PURE__*/
function (_Resolver) {
  _inherits(RowSubscriber, _Resolver);

  function RowSubscriber() {
    _classCallCheck(this, RowSubscriber);

    return _possibleConstructorReturn(this, _getPrototypeOf(RowSubscriber).apply(this, arguments));
  }

  _createClass(RowSubscriber, [{
    key: "_resolve",
    value: function () {

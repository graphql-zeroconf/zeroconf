...
/*#__PURE__*/
function (_Resolver) {
  _inherits(ListSubscriber, _Resolver);

  function ListSubscriber() {
    _classCallCheck(this, ListSubscriber);

    return _possibleConstructorReturn(this, _getPrototypeOf(ListSubscriber).apply(this, arguments));
  }

  _createClass(ListSubscriber, [{
    key: "_resolve",
    value: function () {
